package github.cirqach.devlex.database.FindWordTest
...
class QuestionBaseHelper {
    ...
    private val tag = "find word test"

    data class Question(
        val russianName: String,
        val englishOption1: String,
        val englishOption2: String,
        val englishOption3: String,
            ...
            try {
                ...
                if (questionData != null) { // Check if data is retrieved successfully
                    ...
                    return Question(
                        ...
                        options[0].englishName,
                        options[1].englishName,
                        options[2].englishName,
                        correctOptionIndex
                    )
                }
            } catch (e: Exception) {
